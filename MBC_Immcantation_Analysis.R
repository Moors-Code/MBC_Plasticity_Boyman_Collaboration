...
###################################################################################################################################
# Part 8 - Clonal diversity and expansion analysis - clonotyping done with heavy chain only
###################################################################################################################################
# Comparisons between cell states (after vaccination)
# Similar to above but cell state instead of time after vac.
# Cell states need to be added to the data.
Bmem.Inc <- readRDS("~/NAS/Jan/Experiments and Data/210801 - Exp 035 - Profiling of COVID vaccinated patient samples/Memory B cell Fourth Experiment 220323/multi_exp035_4/Bmem.rds")
setwd("~/NAS/Jan/Experiments and Data/210801 - Exp 035 - Profiling of COVID vaccinated patient samples/scAnalysis/Immcantation Analysis/Immcantation Outputs/diversity")
PFCL1_154583_1943_vacc_early <- read_airr("./PFCL1_154583_1943_vacc_early/outputs/PFCL1_154583_1943_vacc_early_0.20_germ_heavy_only_germ-pass.tsv")
PFCL1_179308_1988_vacc_late <- read_airr("./PFCL1_179308_1988_vacc_late/outputs/PFCL1_179308_1988_vacc_late_0.20_germ_heavy_only_germ-pass.tsv")
PFCL1_199474_1994_vacc_late <- read_airr("./PFCL1_199474_1994_vacc_late/outputs/PFCL1_199474_1994_vacc_late_0.20_germ_heavy_only_germ-pass.tsv")
PFCL1_LIM_137402_vacc_early <- read_airr("./PFCL1_LIM_137402_vacc_early/outputs/PFCL1_LIM_137402_vacc_early_0.20_germ_heavy_only_germ-pass.tsv")
PFCL1_LIM_313000_vacc_early <- read_airr("./PFCL1_LIM_313000_vacc_early/outputs/PFCL1_LIM_313000_vacc_early_0.20_germ_heavy_only_germ-pass.tsv")
PFCL1_LIM828246_vacc_late <- read_airr("./PFCL1_LIM828246_vacc_late/outputs/PFCL1_LIM828246_vacc_late_0.20_germ_heavy_only_germ-pass.tsv")

# Loading the Naive data
setwd("~/NAS/Jan/Experiments and Data/210801 - Exp 035 - Profiling of COVID vaccinated patient samples/scAnalysis/Immcantation Analysis/Naive/Output_data")
PFCL1_179308_1988_naives <- read_airr("PFCL1_179308_1988_naives_automated/outputs/PFCL1_179308_1988_naives_automated_0.2/PFCL1_179308_1988_naives_automated_0.2_heavy_clone-pass.tsv")
PFCL1_199474_1994_naives <- read_airr("PFCL1_199474_1994_naives_automated/outputs/PFCL1_199474_1994_naives_automated_0.2/PFCL1_199474_1994_naives_automated_0.2_heavy_clone-pass.tsv")
PFCL1_LIM_313000_naives <- read_airr("PFCL1_LIM_313000_naives_automated/outputs/PFCL1_LIM_313000_naives_automated_0.2/PFCL1_LIM_313000_naives_automated_0.2_heavy_clone-pass.tsv")
PFCL1_LIM828246_naives <- read_airr("PFCL1_LIM828246_naives_automated/outputs/PFCL1_LIM828246_naives_automated_0.2/PFCL1_LIM828246_naives_automated_0.2_heavy_clone-pass.tsv")

# Making clone_IDs of individual files unique - I don't want to get clones with cells from more than one sample by accident.
PFCL1_154583_1943_vacc_early$clone_id <- paste0(PFCL1_154583_1943_vacc_early$clone_id,111)
PFCL1_179308_1988_vacc_late$clone_id <- paste0(PFCL1_179308_1988_vacc_late$clone_id,222)
PFCL1_199474_1994_vacc_late$clone_id <- paste0(PFCL1_199474_1994_vacc_late$clone_id,333)
PFCL1_LIM_137402_vacc_early$clone_id <- paste0(PFCL1_LIM_137402_vacc_early$clone_id,444)
PFCL1_LIM_313000_vacc_early$clone_id <- paste0(PFCL1_LIM_313000_vacc_early$clone_id,555)
PFCL1_LIM828246_vacc_late$clone_id <- paste0(PFCL1_LIM828246_vacc_late$clone_id,666)
PFCL1_179308_1988_naives$clone_id <- paste0(PFCL1_179308_1988_naives$clone_id,777)
PFCL1_199474_1994_naives$clone_id <- paste0(PFCL1_199474_1994_naives$clone_id,888)
PFCL1_LIM_313000_naives$clone_id <- paste0(PFCL1_LIM_313000_naives$clone_id,999)
PFCL1_LIM828246_naives$clone_id <- paste0(PFCL1_LIM828246_naives$clone_id,000)

# Preparing of cell names for merging data with Seurat object (this only needs to be done for the non naives because I need to get the subsets of these)
b <- 1
for (b in 1:nrow(PFCL1_154583_1943_vacc_early)) {
  if(substr(PFCL1_154583_1943_vacc_early[b,"cell_id"],1,2)=="CC"){
    PFCL1_154583_1943_vacc_early[b,"cell_id"] <- paste0("Dataset_4_",substr(PFCL1_154583_1943_vacc_early[b,"cell_id"],3,nchar(PFCL1_154583_1943_vacc_early[b,"cell_id"])))
  }
  if(substr(PFCL1_154583_1943_vacc_early[b,"cell_id"],1,2)=="AA"){
    PFCL1_154583_1943_vacc_early[b,"cell_id"] <- paste0("Dataset_1_",substr(PFCL1_154583_1943_vacc_early[b,"cell_id"],3,nchar(PFCL1_154583_1943_vacc_early[b,"cell_id"])))
  }
  if(substr(PFCL1_154583_1943_vacc_early[b,"cell_id"],1,2)=="GG"){
    PFCL1_154583_1943_vacc_early[b,"cell_id"] <- paste0("Dataset_2_",substr(PFCL1_154583_1943_vacc_early[b,"cell_id"],3,nchar(PFCL1_154583_1943_vacc_early[b,"cell_id"])))
  }
  if(substr(PFCL1_154583_1943_vacc_early[b,"cell_id"],1,2)=="TT"){
    PFCL1_154583_1943_vacc_early[b,"cell_id"] <- paste0("Dataset_3_",substr(PFCL1_154583_1943_vacc_early[b,"cell_id"],3,nchar(PFCL1_154583_1943_vacc_early[b,"cell_id"])))
  }
}
b <- 1
for (b in 1:nrow(PFCL1_179308_1988_vacc_late)) {
  if(substr(PFCL1_179308_1988_vacc_late[b,"cell_id"],1,2)=="CC"){
    PFCL1_179308_1988_vacc_late[b,"cell_id"] <- paste0("Dataset_4_",substr(PFCL1_179308_1988_vacc_late[b,"cell_id"],3,nchar(PFCL1_179308_1988_vacc_late[b,"cell_id"])))
  }
  if(substr(PFCL1_179308_1988_vacc_late[b,"cell_id"],1,2)=="AA"){
    PFCL1_179308_1988_vacc_late[b,"cell_id"] <- paste0("Dataset_1_",substr(PFCL1_179308_1988_vacc_late[b,"cell_id"],3,nchar(PFCL1_179308_1988_vacc_late[b,"cell_id"])))
  }
  if(substr(PFCL1_179308_1988_vacc_late[b,"cell_id"],1,2)=="GG"){
    PFCL1_179308_1988_vacc_late[b,"cell_id"] <- paste0("Dataset_2_",substr(PFCL1_179308_1988_vacc_late[b,"cell_id"],3,nchar(PFCL1_179308_1988_vacc_late[b,"cell_id"])))
  }
  if(substr(PFCL1_179308_1988_vacc_late[b,"cell_id"],1,2)=="TT"){
    PFCL1_179308_1988_vacc_late[b,"cell_id"] <- paste0("Dataset_3_",substr(PFCL1_179308_1988_vacc_late[b,"cell_id"],3,nchar(PFCL1_179308_1988_vacc_late[b,"cell_id"])))
  }
}
b <- 1
for (b in 1:nrow(PFCL1_199474_1994_vacc_late)) {
  if(substr(PFCL1_199474_1994_vacc_late[b,"cell_id"],1,2)=="CC"){
    PFCL1_199474_1994_vacc_late[b,"cell_id"] <- paste0("Dataset_4_",substr(PFCL1_199474_1994_vacc_late[b,"cell_id"],3,nchar(PFCL1_199474_1994_vacc_late[b,"cell_id"])))
  }
  if(substr(PFCL1_199474_1994_vacc_late[b,"cell_id"],1,2)=="AA"){
    PFCL1_199474_1994_vacc_late[b,"cell_id"] <- paste0("Dataset_1_",substr(PFCL1_199474_1994_vacc_late[b,"cell_id"],3,nchar(PFCL1_199474_1994_vacc_late[b,"cell_id"])))
  }
  if(substr(PFCL1_199474_1994_vacc_late[b,"cell_id"],1,2)=="GG"){
    PFCL1_199474_1994_vacc_late[b,"cell_id"] <- paste0("Dataset_2_",substr(PFCL1_199474_1994_vacc_late[b,"cell_id"],3,nchar(PFCL1_199474_1994_vacc_late[b,"cell_id"])))
  }
  if(substr(PFCL1_199474_1994_vacc_late[b,"cell_id"],1,2)=="TT"){
    PFCL1_199474_1994_vacc_late[b,"cell_id"] <- paste0("Dataset_3_",substr(PFCL1_199474_1994_vacc_late[b,"cell_id"],3,nchar(PFCL1_199474_1994_vacc_late[b,"cell_id"])))
  }
}
b <- 1
for (b in 1:nrow(PFCL1_LIM_137402_vacc_early)) {
  if(substr(PFCL1_LIM_137402_vacc_early[b,"cell_id"],1,2)=="CC"){
    PFCL1_LIM_137402_vacc_early[b,"cell_id"] <- paste0("Dataset_4_",substr(PFCL1_LIM_137402_vacc_early[b,"cell_id"],3,nchar(PFCL1_LIM_137402_vacc_early[b,"cell_id"])))
  }
  if(substr(PFCL1_LIM_137402_vacc_early[b,"cell_id"],1,2)=="AA"){
    PFCL1_LIM_137402_vacc_early[b,"cell_id"] <- paste0("Dataset_1_",substr(PFCL1_LIM_137402_vacc_early[b,"cell_id"],3,nchar(PFCL1_LIM_137402_vacc_early[b,"cell_id"])))
  }
  if(substr(PFCL1_LIM_137402_vacc_early[b,"cell_id"],1,2)=="GG"){
    PFCL1_LIM_137402_vacc_early[b,"cell_id"] <- paste0("Dataset_2_",substr(PFCL1_LIM_137402_vacc_early[b,"cell_id"],3,nchar(PFCL1_LIM_137402_vacc_early[b,"cell_id"])))
  }
  if(substr(PFCL1_LIM_137402_vacc_early[b,"cell_id"],1,2)=="TT"){
    PFCL1_LIM_137402_vacc_early[b,"cell_id"] <- paste0("Dataset_3_",substr(PFCL1_LIM_137402_vacc_early[b,"cell_id"],3,nchar(PFCL1_LIM_137402_vacc_early[b,"cell_id"])))
  }
}
b <- 1
for (b in 1:nrow(PFCL1_LIM_313000_vacc_early)) {
  if(substr(PFCL1_LIM_313000_vacc_early[b,"cell_id"],1,2)=="CC"){
    PFCL1_LIM_313000_vacc_early[b,"cell_id"] <- paste0("Dataset_4_",substr(PFCL1_LIM_313000_vacc_early[b,"cell_id"],3,nchar(PFCL1_LIM_313000_vacc_early[b,"cell_id"])))
  }
  if(substr(PFCL1_LIM_313000_vacc_early[b,"cell_id"],1,2)=="AA"){
    PFCL1_LIM_313000_vacc_early[b,"cell_id"] <- paste0("Dataset_1_",substr(PFCL1_LIM_313000_vacc_early[b,"cell_id"],3,nchar(PFCL1_LIM_313000_vacc_early[b,"cell_id"])))
  }
  if(substr(PFCL1_LIM_313000_vacc_early[b,"cell_id"],1,2)=="GG"){
    PFCL1_LIM_313000_vacc_early[b,"cell_id"] <- paste0("Dataset_2_",substr(PFCL1_LIM_313000_vacc_early[b,"cell_id"],3,nchar(PFCL1_LIM_313000_vacc_early[b,"cell_id"])))
  }
  if(substr(PFCL1_LIM_313000_vacc_early[b,"cell_id"],1,2)=="TT"){
    PFCL1_LIM_313000_vacc_early[b,"cell_id"] <- paste0("Dataset_3_",substr(PFCL1_LIM_313000_vacc_early[b,"cell_id"],3,nchar(PFCL1_LIM_313000_vacc_early[b,"cell_id"])))
  }
}
b <- 1
for (b in 1:nrow(PFCL1_LIM828246_vacc_late)) {
  if(substr(PFCL1_LIM828246_vacc_late[b,"cell_id"],1,2)=="CC"){
    PFCL1_LIM828246_vacc_late[b,"cell_id"] <- paste0("Dataset_4_",substr(PFCL1_LIM828246_vacc_late[b,"cell_id"],3,nchar(PFCL1_LIM828246_vacc_late[b,"cell_id"])))
  }
  if(substr(PFCL1_LIM828246_vacc_late[b,"cell_id"],1,2)=="AA"){
    PFCL1_LIM828246_vacc_late[b,"cell_id"] <- paste0("Dataset_1_",substr(PFCL1_LIM828246_vacc_late[b,"cell_id"],3,nchar(PFCL1_LIM828246_vacc_late[b,"cell_id"])))
  }
  if(substr(PFCL1_LIM828246_vacc_late[b,"cell_id"],1,2)=="GG"){
    PFCL1_LIM828246_vacc_late[b,"cell_id"] <- paste0("Dataset_2_",substr(PFCL1_LIM828246_vacc_late[b,"cell_id"],3,nchar(PFCL1_LIM828246_vacc_late[b,"cell_id"])))
  }
  if(substr(PFCL1_LIM828246_vacc_late[b,"cell_id"],1,2)=="TT"){
    PFCL1_LIM828246_vacc_late[b,"cell_id"] <- paste0("Dataset_3_",substr(PFCL1_LIM828246_vacc_late[b,"cell_id"],3,nchar(PFCL1_LIM828246_vacc_late[b,"cell_id"])))
  }
}

# Addition of cell state
Bmem.subset <- Bmem.Inc@meta.data[,c("named.clusters","bait.positive","Full.Row.names")]
colnames(Bmem.subset) <- c("named.clusters","bait.positive","cell_id")
PFCL1_154583_1943_vacc_early <- merge(PFCL1_154583_1943_vacc_early, Bmem.subset, by="cell_id", all.x = T)
PFCL1_179308_1988_vacc_late <- merge(PFCL1_179308_1988_vacc_late, Bmem.subset, by="cell_id", all.x = T)
PFCL1_199474_1994_vacc_late <- merge(PFCL1_199474_1994_vacc_late, Bmem.subset, by="cell_id", all.x = T)
PFCL1_LIM_137402_vacc_early <- merge(PFCL1_LIM_137402_vacc_early, Bmem.subset, by="cell_id", all.x = T)
PFCL1_LIM_313000_vacc_early <- merge(PFCL1_LIM_313000_vacc_early, Bmem.subset, by="cell_id", all.x = T)
PFCL1_LIM828246_vacc_late <- merge(PFCL1_LIM828246_vacc_late, Bmem.subset, by="cell_id", all.x = T)

# Addition of the respective columns to the files of the naive cells.
PFCL1_179308_1988_naives$germline_alignment_d_mask <- "empty"
PFCL1_199474_1994_naives$germline_alignment_d_mask <- "empty"
PFCL1_LIM_313000_naives$germline_alignment_d_mask <- "empty"
PFCL1_LIM828246_naives$germline_alignment_d_mask <- "empty"

PFCL1_179308_1988_naives$germline_v_call <- "empty"
PFCL1_199474_1994_naives$germline_v_call <- "empty"
PFCL1_LIM_313000_naives$germline_v_call <- "empty"
PFCL1_LIM828246_naives$germline_v_call <- "empty"

PFCL1_179308_1988_naives$germline_d_call <- "empty"
PFCL1_199474_1994_naives$germline_d_call <- "empty"
PFCL1_LIM_313000_naives$germline_d_call <- "empty"
PFCL1_LIM828246_naives$germline_d_call <- "empty"

PFCL1_179308_1988_naives$germline_j_call <- "empty"
PFCL1_199474_1994_naives$germline_j_call <- "empty"
PFCL1_LIM_313000_naives$germline_j_call <- "empty"
PFCL1_LIM828246_naives$germline_j_call <- "empty"

PFCL1_179308_1988_naives$named.clusters <- "Naive"
PFCL1_199474_1994_naives$named.clusters <- "Naive"
PFCL1_LIM_313000_naives$named.clusters <- "Naive"
PFCL1_LIM828246_naives$named.clusters <- "Naive"

PFCL1_179308_1988_naives$bait.positive <- "empty"
PFCL1_199474_1994_naives$bait.positive <- "empty"
PFCL1_LIM_313000_naives$bait.positive <- "empty"
PFCL1_LIM828246_naives$bait.positive <- "empty"


all.cells <- rbind(PFCL1_154583_1943_vacc_early,PFCL1_179308_1988_vacc_late,PFCL1_199474_1994_vacc_late,PFCL1_LIM_137402_vacc_early,
                   PFCL1_LIM_313000_vacc_early,PFCL1_LIM828246_vacc_late,PFCL1_179308_1988_naives,PFCL1_199474_1994_naives,
                   PFCL1_LIM_313000_naives,PFCL1_LIM828246_naives)
all.cells$named.clusters <- as.character(all.cells$named.clusters)
all.cells$named.clusters[all.cells$named.clusters=="CD27high RM"] <- "RM"
all.cells$named.clusters[all.cells$named.clusters=="CD27low RM"] <- "RM"

all.cells <- all.cells[all.cells$named.clusters != "Unswitched",]

###
# This section is only needed if patient specific analysis is done
all.cells <- all.cells[all.cells$]

###

abundance <- estimateAbundance(all.cells, group = "named.clusters")
plot(abundance)

d <- alphaDiversity(all.cells, group = "named.clusters", nboot=1000)
p <- plot(d, silent = T,colors=c("#AA3377","#4477AA","gray50","orange"),legend_title="Subset")
p + geom_vline(xintercept = c(0,1,2), color = "grey50", linetype = "dashed") + 
  geom_text(data = data.frame(q = c(0,1,2), y = round(max(p$data$d_upper)/2), 
                              label = c("Richness p<0.001", "Shannon p<0.001", "Simpson p<0.008")), 
            aes(x = q, y = y,label = label), size = 4, angle = 90, vjust = -0.4, inherit.aes  =  F, color = "gray24")+
  center.title()+ggtitle("")+black.axis.text()+theme(legend.title=element_text(size=14),legend.text=element_text(size=12),
                                                     axis.text.x = element_text(size = 11),axis.text.y = element_text(size=11),
                                                     axis.title.x = element_text(size = 12),axis.title.y = element_text(size = 12)) # Export 5x7

test <- alphaDiversity(all.cells, group="named.clusters", min_q=0, max_q=2, step_q=1, nboot=1000, clone="clone_id")
print(test@tests)

remove(abundance, Bmem.Inc, Bmem.subset, d, p, PFCL1_154583_1943_vacc_early,PFCL1_179308_1988_vacc_late,PFCL1_199474_1994_vacc_late,
       PFCL1_LIM_137402_vacc_early,PFCL1_LIM_313000_vacc_early,PFCL1_LIM828246_vacc_late,test,b)
write.csv(test@tests,"Diversity.all.statistics.csv")


colnames(all.cells)
all.cells <- all.cells[,c("named.clusters","clone_id")]
all.cells.RM <- all.cells[all.cells$named.clusters=="RM",]
all.cells.Activated <- all.cells[all.cells$named.clusters=="Activated",]
all.cells.Atypical <- all.cells[all.cells$named.clusters=="Atypical",]
all.cells.Naive <- all.cells[all.cells$named.clusters=="Naive",]

all.cells.RM <- all.cells.RM %>% group_by(clone_id) %>% add_tally()
all.cells.Activated <- all.cells.Activated %>% group_by(clone_id) %>% add_tally()
all.cells.Atypical <- all.cells.Atypical %>% group_by(clone_id) %>% add_tally()
all.cells.Naive <- all.cells.Naive %>% group_by(clone_id) %>% add_tally()

all.cells.RM <- unique(all.cells.RM)
all.cells.Activated <- unique(all.cells.Activated)
all.cells.Atypical <- unique(all.cells.Atypical)
all.cells.Naive <- unique(all.cells.Naive)

all.cells.RM <- arrange(all.cells.RM,desc(n))
all.cells.Activated <- arrange(all.cells.Activated,desc(n))
all.cells.Atypical <- arrange(all.cells.Atypical,desc(n))
all.cells.Naive <- arrange(all.cells.Naive,desc(n))

D50.calculator <- function(X){
  n.distinct.sequences <- nrow(X)
  total.colsum <- sum(X[,3])
  i <- 1
  for(i in 1:nrow(X)){
    sum <- sum(X[1:i,3])
  if(sum>=total.colsum/2){
    D50 <- i/n.distinct.sequences
    break
  }
  i <- i+1
  }
...
D20.calculator <- function(X){
  n.distinct.sequences <- nrow(X)
  total.colsum <- sum(X[,3])
  i <- 1
  for(i in 1:nrow(X)){
    sum <- sum(X[1:i,3])
    if(sum>=total.colsum/5){
      D50 <- i/n.distinct.sequences
      break
    }
    i <- i+1
 ...
 <- function(X){
  number.sequences.top.20 <- sum(X[1:20,3])
  number.of.sequences <- sum(X[,3])
  return(100*(number.sequences.top.20/number.of.sequences))
}


D50.calculator(all.cells.Naive)
D50.calculator(all.cells.RM)
D50.calculator(all.cells.Activated)
D50.calculator(all.cells.Atypical)

D20.calculator(all.cells.Naive)
D20.calculator(all.cells.RM)
D20.calculator(all.cells.Activated)
D20.calculator(all.cells.Atypical)

D20.calculator.Wherry(all.cells.Naive)
D20.calculator.Wherry(all.cells.RM)
D20.calculator.Wherry(all.cells.Activated)
D20.calculator.Wherry(all.cells.Atypical)

results.df <- data.frame(Subset=c("Naive","RM","Activated","Atypical"),D50=c(D50.calculator(all.cells.Naive),D50.calculator(all.cells.RM),
                                                                             D50.calculator(all.cells.Activated),D50.calculator(all.cells.Atypical)))

results.df2 <- data.frame(Subset=c("Naive","RM","Activated","Atypical"),D50=c(D20.calculator.Wherry(all.cells.Naive),D20.calculator.Wherry(all.cells.RM),
...
###################################################################################################################################
# Part 9 - Analysis of cells belonging to persistent clones and the 12 months time point - Fig.6.B and part of Fig.6.D
###################################################################################################################################
...
###################################################################################################################################
# Part 10 - Creating a Venn Diagrams - Supp.Fig.6.A and Supp.Fig.6.B
###################################################################################################################################
